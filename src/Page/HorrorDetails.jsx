...
const HorrorDetails = () => {
    ...
    const {horrorId} = useParams()
    const {movie} = CustomHookDetails(`https://api.themoviedb.org/3/movie/${horrorId}?api_key=aa102bc6f62ad721b21bf7634f3689fb&language=en-US`)
